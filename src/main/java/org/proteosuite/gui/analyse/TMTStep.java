 ...
 * @author SPerkins
 */
public class TMTStep extends JPanel {
	private static final long serialVersionUID = 1L;
        ...
        public TMTStep() {
            ...
            JLabel stepTitle = new JLabel(
				"Confirm your quantitation type as TMT:");
		stepTitle.setFont(new Font(stepTitle.getFont().getFontName(), stepTitle
				...
				"Your identifications will be automatically created and/or loaded in the background.\n"
						...
						+ "TMT quantitation is provided by xTracker.");
		...
		buttonsPanel
				.add(new JLabel(
						"CLICK CONFIRM TO CONFIRM QUANTITATION TYPE AS TMT AND RUN ANALYSIS"));
