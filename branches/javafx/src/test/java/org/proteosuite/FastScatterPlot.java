...
public class FastScatterPlot extends Plot implements ValueAxisPlot, 
    ...
    public void zoomDomainAxes(double d, PlotRenderingInfo pri, Point2D pd, boolean bln) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public void zoomRangeAxes(double d, PlotRenderingInfo pri, Point2D pd, boolean bln) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
