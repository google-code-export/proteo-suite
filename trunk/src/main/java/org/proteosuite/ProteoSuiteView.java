...
public class ProteoSuiteView extends JFrame {
    ...
    private void initComponents(final JMenuItem jmCloseProject,
        ...
        jtMzIDProtGroup.setModel(new DefaultTableModel(new String[][]{}, new String[]{"ID", "Name", "Protein Accesions",
    ...
    public void jmNewProjectActionPerformed(JComboBox<String> jcbTechnique,
        ...
        if (WORKSPACE.isProjectModified()) {
    ...
    public void jmCloseProjectActionPerformed(JMenuItem jmCloseProject,
        ...
        jmNewProjectActionPerformed(jcbTechnique, jmSaveProject, jmCloseProject, jtpLog, jtpViewer, jbSaveProject, jcbOutputFormat,
            jepMGFView, jepMZQView, jepMascotXMLView, jepMzIDView,
            jepMzMLView, jlFileNameMzMLText, jlFileNameMzIDText, jlIdentFilesStatus,
            jlFileNameMzQText, jtRawFiles, jtIdentFiles, jtQuantFiles, jtRawData, jtMzML, jtMGF,
     ...
     * Display MZQ data
     *
     * @param iIndex - Index to the aMzQUnmarshaller list
