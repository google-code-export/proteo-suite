...
public class XYBlockChartDemo1bk extends ApplicationFrame {

    public XYBlockChartDemo1bk(String title) {
    ...
    public static void main(String[] args) {
        XYBlockChartDemo1bk demo = new XYBlockChartDemo1bk("2D View");
        demo.pack();
